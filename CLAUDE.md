...
**Stránkování:** Platby (`payments/page.tsx`) používají cursor-based stránkování (`Načíst další`), ostatní seznamy zobrazují vše najednou (data se načítají celá z API).
...
| Sekce | Sloupce (šířky) |
|-------|----------------|
| Vybavení | checkbox 4%, typ 22%, stav 11%, poznámky 63% (bez sloupce cena) |
...
8. **Vyžádej si potvrzení pro commit** — ukaž co se změnilo a zeptej se "Mám commitnout a pushnout?"
9. **Commitni a pushni** každý úkol zvlášť s výstižnou českou commit message
