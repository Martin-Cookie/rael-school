          ...
          <div className="mb-4 space-y-2">
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 min-w-0 px-4 py-2.5 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-primary-500 dark:focus:ring-primary-400 outline-none text-sm"
            ...
            {showPrice && setNewPrice && (
              <input
                ...
                className="w-32 px-3 py-2.5 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-primary-500 dark:focus:ring-primary-400 outline-none text-sm"
                onKeyDown={(e) => e.key === 'Enter' && onAdd()}
              />
            )}
            {/* Translation fields */}
                  ...
                  <div className="flex items-center gap-3 px-4 py-3">
                    ...
                    {editingNameId === item.id ? (
                      <input
                        ...
                        className="flex-1 min-w-0 px-2 py-1 rounded-lg border border-primary-400 dark:border-primary-500 dark:bg-gray-700 dark:text-gray-100 text-sm font-medium focus:ring-2 focus:ring-primary-500 dark:focus:ring-primary-400 outline-none"
                        autoFocus
                      />
                    ) : (
                      <button
                    ...
                    <button
                      ...
                      className="p-2 text-gray-400 hover:text-blue-500 opacity-0 group-hover:opacity-100 transition-opacity rounded-lg"
